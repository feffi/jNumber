...
public class ValidationExceptionTest {
  ...
  public void testValidationExceptionString() {
    ...
    Assert.assertTrue(validationException.getMessage().equals(DEFAULT_VALIDATION_EXCEPTION));
  }
  ...
  public void testValidationExceptionStringThrowable() {
    final List<ValidationException> validationErrors = new ArrayList<ValidationException>();
    validationErrors.add(new ValidationException("Testexception 13"));
  ...
  public void testValidationExceptionStringThrowableListOfValidationException() {
    ...
    Assert.assertTrue(expected.containsAll(validationErrors));
    Assert.assertTrue(validationException.getMessage().equals(DEFAULT_VALIDATION_EXCEPTION));
    Assert.assertTrue(validationException.getCause().getMessage().equals("Testexception 18"));
  }
  ...
  public void testValidationExceptionThrowable() {
    ...
    Assert.assertTrue(validationException.getValidationErrors().isEmpty());
    Assert.assertTrue(validationException.getCause().getMessage().equals("Testexception 19"));
  }
  ...
  public void testValidationExceptionThrowableListOfValidationException() {
    ...
    final List<ValidationException> expected = validationException.getValidationErrors();
    Assert.assertTrue(expected.containsAll(validationErrors));
    Assert.assertTrue(validationException.getCause().getMessage().equals("Testexception 23"));
  }
}
